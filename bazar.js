/* =============================== GLOBAL CONFERENCE JS ================================ */
document.addEventListener("DOMContentLoaded", () => {

    /* =============================== 1. SCROLL REVEAL (ADVANCED) ================================ */
    ...
    const hero = document.querySelector(".hero-conference");
    ...
    progressBar.style.background = "#83775f";
    ...
    const bookingForm = document.getElementById("conferenceBookingForm");
    bookingForm.addEventListener("submit", e => {
        ...
        alert("Conference booking submitted successfully!");
        bookingForm.reset();
