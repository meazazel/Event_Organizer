// travel-tours.js - Enhanced version for Travel Tours page
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    (entries) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          ...
          // Optional: stop observing after animation once
  ...
  // 1. Main Highlights Slider (full-width hero style - 3 slides)
  const highlightsSlider = setupSlider(".highlights-slider", null, 6500);

  // 2. Other section sliders (like conference/adventure slider-track)
  ...
  // ── OPTIONAL: Add arrow controls (if you add buttons to HTML) ───────
  // Example HTML: <button class="slider-prev">←</button> <button class="slider-next">→</button>
  ...
  // You can extend this for more specific sliders later
});
document.addEventListener("DOMContentLoaded", () => {
